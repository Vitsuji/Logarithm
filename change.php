...
$np = hash('ripemd160',sha1(sha1(md5(md5(sha1(md5($np)))))));
...
if($vres ){
$vresr = mysqli_fetch_assoc($vres);
if($vresr['username'] === Null){
$a .= "Invalid Key";
}else{
//key valid
...
<div class="mainm">
<h1>Do not forget <strong>Logarithm</strong></h1>
</div>
<div class="upperi"><h3 style="letter-spacing:2px;">Forgot Password?</h3></div>
...
<!--[if IE 8]><h3 style="color:white;text-align:center;">New Password</h3><![endif]-->
    <input placeholder="New password"type="password" class="maininput"  name="npassword" required>
    <input placeholder="Confirm password"type="password" class="maininput"  name="cpassword" required>
    <input style="margin-top:7px;" type="submit" name="btn" class="btn-style" value="Change password" >
</form>
